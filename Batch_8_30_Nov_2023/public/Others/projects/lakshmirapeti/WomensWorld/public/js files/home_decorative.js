...
function loadproducts(data) {
  ...
  var main = document.querySelector('#Pdecorative');
  main.appendChild(ultag)

}

function decorativeproducts() {
  axios.get('/home/decortive/products', {}).then((response) => {
    // console.log(response.data)
    decorativelist = response.data;
    for (var i = 0; i < decorativelist.length; i++) {
      loadproducts(decorativelist[i]);
    }
...
var decorative = document.getElementById("decoratives");
// WesternWear
